...
function addBodies(world, Physics, data){
    ...
    for (var j = 0; j < numAnswers; j++) {
        ...
        var numCircles = Math.floor(dataArray[j]/overallFreq  * 60);
        ...
        for (var i = 0; i < numCircles; i++) {
            ...
            bodies.push({ name: 'circle', restitution: 0.9,  styles: {fillStyle: dataColorsAlt[j]},
                x: randX, y: randY, vx: randVX, radius: radius});
        }
    }
